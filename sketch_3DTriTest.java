...
public class sketch_3DTriTest extends PApplet{
  ...
  private Graphic[] sprites = new Graphic[2];
  ...
  public void setup(){
    ...
    sprites[0] = new Graphic(PATH_BASE+"billboards/testImage.png");
    sprites[1] = new Graphic(PATH_BASE+"billboards/testImage2.png");
