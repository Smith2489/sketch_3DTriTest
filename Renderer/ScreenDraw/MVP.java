...
public class MVP{
  ...
  public static Matrix4x4 modelMatrix(){
    ...
    Matrix4x4 step1 = MatrixOperations.matrixMultiply(MatrixOperations.matrixMultiply(translate, rotate), scale);
  ...
  public static Matrix4x4 viewMatrix(){
    ...
    Matrix4x4 step1 = MatrixOperations.matrixMultiply(MatrixOperations.matrixMultiply(shear, scale), rotate);
  ...
  public static Matrix4x4 inverseViewMatrix(float[] pos, float[] angles, float[] scale, float[][] shear){
    ...
    Matrix4x4 step1 = MatrixOperations.matrixMultiply(MatrixOperations.matrixMultiply(translate, rotate), scaling);
